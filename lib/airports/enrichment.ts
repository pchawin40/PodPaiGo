...
export const AIRPORT_SEARCH_ALIASES: Record<string, string[]> = {
  ...
  MCO: ['orlando', 'orlando airport'],
  BOS: ['boston', 'boston airport'],
  DEN: ['denver', 'denver airport'],
  PHX: ['phoenix', 'phoenix airport'],
  BNA: ['nashville', 'nashville airport'],
  MSP: ['minneapolis', 'minneapolis airport', 'twin cities'],
  ANC: ['anchorage', 'anchorage airport'],
  HNL: ['honolulu', 'honolulu airport'],
