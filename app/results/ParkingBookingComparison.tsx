              ...
              >
                <div className="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
                  <div className="flex min-w-0 flex-col gap-3 sm:flex-row">
                    {r.imageUrl && (
                      <div className="h-32 w-full overflow-hidden rounded-xl bg-zinc-100 sm:h-16 sm:w-20 sm:shrink-0">
                        <img
                          src={r.imageUrl}
                  ...
                  {r.link ? (
                    <a
                      ...
                      className="inline-flex w-full shrink-0 items-center justify-center rounded-xl bg-blue-600 px-4 py-2 text-sm font-semibold text-white hover:bg-blue-700 sm:w-auto"
                    >
                      Open
                    </a>
                  ) : (
